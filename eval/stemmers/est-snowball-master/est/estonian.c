...
extern "C" {
#endif
extern int ./est-snowball-master/H_stem(struct SN_env * z);
#ifdef __cplusplus
}
#endif
...
extern struct SN_env * ./est-snowball-master/H_create_env(void);
extern void ./est-snowball-master/H_close_env(struct SN_env * z);
...
static const symbol s_5[] = { 'm', 'i', 's' };
static const symbol s_6[] = { 'e' };
static const symbol s_7[] = { 'l', 'a', 's' };
static const symbol s_8[] = { 'e' };
static const symbol s_9[] = { 'l', 'i', 's' };
static const symbol s_10[] = { 'e' };
static const symbol s_11[] = { 't' };
static const symbol s_12[] = { 'j', 'o', 'o' };
static const symbol s_13[] = { 's', 'a', 'a' };
static const symbol s_14[] = { 'v', 'i', 'i', 'm', 'a' };
static const symbol s_15[] = { 'k', 'e', 'e', 's', 'i' };
static const symbol s_16[] = { 'l', 0xC3, 0xB6, 0xC3, 0xB6 };
static const symbol s_17[] = { 'l', 0xC3, 0xB6, 'i' };
static const symbol s_18[] = { 'l', 'o', 'o' };
static const symbol s_19[] = { 'k', 0xC3, 0xA4, 'i', 's', 'i' };
static const symbol s_20[] = { 's', 0xC3, 0xB6, 0xC3, 0xB6 };
static const symbol s_21[] = { 't', 'o', 'o' };
static const symbol s_22[] = { 'v', 0xC3, 0xB5, 'i', 's', 'i' };
static const symbol s_23[] = { 'j', 0xC3, 0xA4, 0xC3, 0xA4, 'm', 'a' };
static const symbol s_24[] = { 'm', 0xC3, 0xBC, 0xC3, 0xBC, 's', 'i' };
static const symbol s_25[] = { 'l', 'u', 'g', 'e' };
static const symbol s_26[] = { 'p', 0xC3, 0xB5, 'd', 'e' };
static const symbol s_27[] = { 'l', 'a', 'd', 'u' };
static const symbol s_28[] = { 't', 'e', 'g', 'i' };
static const symbol s_29[] = { 'n', 0xC3, 0xA4, 'g', 'i' };
...
static int r_verb(struct SN_env * z) { /* backwardmode */
    ...
    switch (among_var) { /* among, line 62 */
        case 1:
            ...
            break;
        case 2:
            {   int ret = slice_from_s(z, 1, s_0); /* <-, line 68 */
                if (ret < 0) return ret;
            }
            break;
        case 3:
...
static int r_special_noun_endings(struct SN_env * z) { /* backwardmode */
    ...
    switch (among_var) { /* among, line 93 */
        case 1:
            {   int ret = slice_from_s(z, 4, s_1); /* <-, line 94 */
                if (ret < 0) return ret;
            }
            break;
        case 2:
            {   int ret = slice_from_s(z, 4, s_2); /* <-, line 98 */
                if (ret < 0) return ret;
            }
            break;
        case 3:
            {   int ret = slice_from_s(z, 4, s_3); /* <-, line 102 */
                if (ret < 0) return ret;
            }
            break;
    }
...
static int r_plural_three_first_cases(struct SN_env * z) { /* backwardmode */
    ...
    switch (among_var) { /* among, line 129 */
        case 1:
            {   int ret = slice_from_s(z, 3, s_4); /* <-, line 130 */
                if (ret < 0) return ret;
            }
            break;
        case 2:
        ...
        case 3:
            {   int m3 = z->l - z->c; (void)m3; /* or, line 134 */
                ...
                {   int m5 = z->l - z->c; (void)m5; /* or, line 134 */
                    if (!(eq_s_b(z, 3, s_5))) goto lab4; /* literal, line 134 */
                    {   int ret = slice_from_s(z, 1, s_6); /* <-, line 134 */
                        if (ret < 0) return ret;
                    }
                    goto lab3;
                lab4:
                    z->c = z->l - m5;
                    if (!(eq_s_b(z, 3, s_7))) goto lab5; /* literal, line 134 */
                ...
                lab5:
                    z->c = z->l - m5;
                    if (!(eq_s_b(z, 3, s_9))) goto lab6; /* literal, line 134 */
            ...
            lab2:
                ...
                {   int ret = slice_from_s(z, 1, s_11); /* <-, line 134 */
                    if (ret < 0) return ret;
                }
            }
        lab1:
...
static int r_verb_exceptions(struct SN_env * z) { /* forwardmode */
    ...
    switch (among_var) { /* among, line 186 */
        case 1:
            {   int ret = slice_from_s(z, 3, s_12); /* <-, line 187 */
                if (ret < 0) return ret;
            }
            break;
        case 2:
            {   int ret = slice_from_s(z, 3, s_13); /* <-, line 190 */
                if (ret < 0) return ret;
            }
            break;
        case 3:
            {   int ret = slice_from_s(z, 5, s_14); /* <-, line 194 */
                if (ret < 0) return ret;
            }
            break;
        case 4:
            {   int ret = slice_from_s(z, 5, s_15); /* <-, line 198 */
                if (ret < 0) return ret;
            }
            break;
        case 5:
            {   int ret = slice_from_s(z, 5, s_16); /* <-, line 201 */
                if (ret < 0) return ret;
            }
            break;
        case 6:
            {   int ret = slice_from_s(z, 4, s_17); /* <-, line 204 */
                if (ret < 0) return ret;
            }
            break;
        case 7:
            {   int ret = slice_from_s(z, 3, s_18); /* <-, line 205 */
                if (ret < 0) return ret;
            }
            break;
        case 8:
            {   int ret = slice_from_s(z, 6, s_19); /* <-, line 208 */
                if (ret < 0) return ret;
            }
            break;
        case 9:
            {   int ret = slice_from_s(z, 5, s_20); /* <-, line 211 */
                if (ret < 0) return ret;
            }
            break;
        case 10:
            {   int ret = slice_from_s(z, 3, s_21); /* <-, line 215 */
                if (ret < 0) return ret;
            }
            break;
        case 11:
            {   int ret = slice_from_s(z, 6, s_22); /* <-, line 219 */
                if (ret < 0) return ret;
            }
            break;
        case 12:
            {   int ret = slice_from_s(z, 7, s_23); /* <-, line 222 */
                if (ret < 0) return ret;
            }
            break;
        case 13:
            {   int ret = slice_from_s(z, 7, s_24); /* <-, line 226 */
                if (ret < 0) return ret;
            }
            break;
        case 14:
            {   int ret = slice_from_s(z, 4, s_25); /* <-, line 229 */
                if (ret < 0) return ret;
            }
            break;
        case 15:
            {   int ret = slice_from_s(z, 5, s_26); /* <-, line 231 */
                if (ret < 0) return ret;
            }
            break;
        case 16:
            {   int ret = slice_from_s(z, 4, s_27); /* <-, line 233 */
                if (ret < 0) return ret;
            }
            break;
        case 17:
            {   int ret = slice_from_s(z, 4, s_28); /* <-, line 235 */
                if (ret < 0) return ret;
            }
            break;
        case 18:
            {   int ret = slice_from_s(z, 5, s_29); /* <-, line 238 */
                if (ret < 0) return ret;
            }
            break;
    }
...
extern int ./est-snowball-master/H_stem(struct SN_env * z) { /* forwardmode */
    {   int c1 = z->c; /* do, line 246 */
        {   int ret = r_mark_regions(z); /* call mark_regions, line 246 */
            if (ret == 0) goto lab0;
            if (ret < 0) return ret;
        }
    lab0:
    ...
    {   int c2 = z->c; /* not, line 247 */
        {   int ret = r_verb_exceptions(z); /* call verb_exceptions, line 247 */
            if (ret == 0) goto lab1;
            if (ret < 0) return ret;
        }
        return 0;
    ...
    z->B[0] = 0; /* unset is_verb, line 248 */
    z->lb = z->c; z->c = z->l; /* backwards, line 249 */

    {   int m3 = z->l - z->c; (void)m3; /* do, line 250 */
        {   int ret = r_emphasis(z); /* call emphasis, line 250 */
            if (ret == 0) goto lab2;
            if (ret < 0) return ret;
        }
    lab2:
    ...
    {   int m4 = z->l - z->c; (void)m4; /* do, line 251 */
        {   int ret = r_verb(z); /* call verb, line 251 */
            if (ret == 0) goto lab3;
            if (ret < 0) return ret;
        }
    lab3:
    ...
    {   int m5 = z->l - z->c; (void)m5; /* try, line 252 */
        /* not, line 252 */
        if (!(z->B[0])) goto lab5; /* Boolean test is_verb, line 252 */
        { z->c = z->l - m5; goto lab4; }
    lab5:
        /* do, line 252 */
        {   int ret = r_substantive(z); /* call substantive, line 252 */
            if (ret == 0) goto lab6;
            if (ret < 0) return ret;
        }
    lab6:
    ...
    {   int m6 = z->l - z->c; (void)m6; /* do, line 253 */
        {   int ret = r_remove_double_kpt(z); /* call remove_double_kpt, line 253 */
            if (ret == 0) goto lab7;
            if (ret < 0) return ret;
        }
    lab7:
...
extern struct SN_env * ./est-snowball-master/H_create_env(void) { return SN_create_env(0, 1, 1); }

extern void ./est-snowball-master/H_close_env(struct SN_env * z) { SN_close_env(z, 0); }
